...
const Contacts = () => {
  return (
    <div name='contact' className='w-full h-screen bg-[#0a192f] flex justify-center items-center p-4'>
        <form method='POST' action="https://getform.io/f/18381752-9c4d-4b0a-80f5-92fcd2c3c828" className='flex flex-col max-w-[600px] w-full'>
            <div className='pb-8'>
            ...
            <input className='my-4 p-2 bg-[#ccd6f6]' type="email" placeholder='Email or Tel' name='email' />
